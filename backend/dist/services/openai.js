...
const cropToTelegramCover = async (input) => {
...
export const generateChannelCover = async (prompt, style, quality = "standard") => {
    ...
    if (!b64)
        throw new Error("DALL-E returned empty image payload");
